# Slice 008 — UCF graph traversal query API

Copy-paste prompt for executing slice 008. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/008-ucf-graph-traversal-api.md.

Branch: catalog/008-ucf-graph-traversal-api (from main).
...
Open PR titled "feat(catalog): UCF graph traversal query API (#008)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 008-ucf-graph-traversal-api).
```
...
- Issue file: [`docs/issues/008-ucf-graph-traversal-api.md`](../../../docs/issues/008-ucf-graph-traversal-api.md)
- Cluster: `catalog`
- Branch: `catalog/008-ucf-graph-traversal-api`
- PRD id: `008-ucf-graph-traversal-api`
