# Slice 046 — 1Password connector

Copy-paste prompt for executing slice 046. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/046-1password-connector.md.

Branch: connectors/046-1password-connector (from main).
...
Open PR titled "feat(connectors): 1Password connector (#046)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 046-1password-connector).
```
...
- Issue file: [`docs/issues/046-1password-connector.md`](../../../docs/issues/046-1password-connector.md)
- Cluster: `connectors`
- Branch: `connectors/046-1password-connector`
- PRD id: `046-1password-connector`
