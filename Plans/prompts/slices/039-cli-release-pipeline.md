# Slice 039 — CLI binary distribution + release pipeline

Copy-paste prompt for executing slice 039. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/039-cli-release-pipeline.md.

Branch: infra/039-cli-release-pipeline (from main).
...
Open PR titled "feat(infra): CLI binary distribution + release pipeline (#039)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 039-cli-release-pipeline).
```
...
- Issue file: [`docs/issues/039-cli-release-pipeline.md`](../../../docs/issues/039-cli-release-pipeline.md)
- Cluster: `infra`
- Branch: `infra/039-cli-release-pipeline`
- PRD id: `039-cli-release-pipeline`
