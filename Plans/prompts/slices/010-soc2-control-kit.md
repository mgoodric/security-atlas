# Slice 010 — SCF-anchored control kit (50 SOC 2 controls bundled)

Copy-paste prompt for executing slice 010. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/010-soc2-control-kit.md.

Branch: control-as-code/010-soc2-control-kit (from main).
...
Open PR titled "feat(control-as-code): SCF-anchored control kit (50 SOC 2 controls bundled) (#010)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 010-soc2-control-kit).
```
...
- Issue file: [`docs/issues/010-soc2-control-kit.md`](../../../docs/issues/010-soc2-control-kit.md)
- Cluster: `control-as-code`
- Branch: `control-as-code/010-soc2-control-kit`
- PRD id: `010-soc2-control-kit`
