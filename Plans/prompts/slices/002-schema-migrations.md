# Slice 002 — schema + migrations for six primitives + FrameworkScope + tenancy plumbing

Copy-paste prompt for executing slice 002. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/002-schema-migrations.md.

Branch: spine/002-schema-migrations (from main).
...
Open PR titled "feat(spine): schema + migrations for six primitives + FrameworkScope + tenancy plumbing (#002)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 002-schema-migrations).
```
...
- Issue file: [`docs/issues/002-schema-migrations.md`](../../../docs/issues/002-schema-migrations.md)
- Cluster: `spine`
- Branch: `spine/002-schema-migrations`
- PRD id: `002-schema-migrations`
