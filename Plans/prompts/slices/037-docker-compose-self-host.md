# Slice 037 — docker-compose self-host bundle

Copy-paste prompt for executing slice 037. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/037-docker-compose-self-host.md.

Branch: infra/037-docker-compose-self-host (from main).
...
Open PR titled "feat(infra): docker-compose self-host bundle (#037)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 037-docker-compose-self-host).
```
...
- Issue file: [`docs/issues/037-docker-compose-self-host.md`](../../../docs/issues/037-docker-compose-self-host.md)
- Cluster: `infra`
- Branch: `infra/037-docker-compose-self-host`
- PRD id: `037-docker-compose-self-host`
