# Slice 044 — GitHub connector

Copy-paste prompt for executing slice 044. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/044-github-connector.md.

Branch: connectors/044-github-connector (from main).
...
Open PR titled "feat(connectors): GitHub connector (#044)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 044-github-connector).
```
...
- Issue file: [`docs/issues/044-github-connector.md`](../../../docs/issues/044-github-connector.md)
- Cluster: `connectors`
- Branch: `connectors/044-github-connector`
- PRD id: `044-github-connector`
