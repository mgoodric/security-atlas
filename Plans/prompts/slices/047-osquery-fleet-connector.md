# Slice 047 — osquery / Fleet endpoint connector

Copy-paste prompt for executing slice 047. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/047-osquery-fleet-connector.md.

Branch: connectors/047-osquery-fleet-connector (from main).
...
Open PR titled "feat(connectors): osquery / Fleet endpoint connector (#047)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 047-osquery-fleet-connector).
```
...
- Issue file: [`docs/issues/047-osquery-fleet-connector.md`](../../../docs/issues/047-osquery-fleet-connector.md)
- Cluster: `connectors`
- Branch: `connectors/047-osquery-fleet-connector`
- PRD id: `047-osquery-fleet-connector`
