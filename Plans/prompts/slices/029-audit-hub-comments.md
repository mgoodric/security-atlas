...
Copy-paste prompt for executing slice 029. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/029-audit-hub-comments.md.

Branch: audit/029-audit-hub-comments (from main).
...
Open PR titled "feat(audit): Audit Hub threaded comments (#029)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 029-audit-hub-comments).
```
...
- Issue file: [`docs/issues/029-audit-hub-comments.md`](../../../docs/issues/029-audit-hub-comments.md)
- Cluster: `audit`
- Branch: `audit/029-audit-hub-comments`
- PRD id: `029-audit-hub-comments`
