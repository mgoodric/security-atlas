# Slice 031 — Monthly board brief (templated, no LLM)

Copy-paste prompt for executing slice 031. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/031-monthly-board-brief.md.

Branch: board/031-monthly-board-brief (from main).
...
Open PR titled "feat(board): Monthly board brief (templated, no LLM) (#031)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 031-monthly-board-brief).
```
...
- Issue file: [`docs/issues/031-monthly-board-brief.md`](../../../docs/issues/031-monthly-board-brief.md)
- Cluster: `board`
- Branch: `board/031-monthly-board-brief`
- PRD id: `031-monthly-board-brief`
