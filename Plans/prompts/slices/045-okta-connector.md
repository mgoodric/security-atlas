# Slice 045 — Okta connector

Copy-paste prompt for executing slice 045. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/045-okta-connector.md.

Branch: connectors/045-okta-connector (from main).
...
Open PR titled "feat(connectors): Okta connector (#045)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 045-okta-connector).
```
...
- Issue file: [`docs/issues/045-okta-connector.md`](../../../docs/issues/045-okta-connector.md)
- Cluster: `connectors`
- Branch: `connectors/045-okta-connector`
- PRD id: `045-okta-connector`
