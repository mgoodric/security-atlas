# Slice 006 — SCF catalog importer + Framework / FrameworkVersion API

Copy-paste prompt for executing slice 006. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/006-scf-catalog-importer.md.

Branch: catalog/006-scf-catalog-importer (from main).
...
Open PR titled "feat(catalog): SCF catalog importer + Framework / FrameworkVersion API (#006)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 006-scf-catalog-importer).
```
...
- Issue file: [`docs/issues/006-scf-catalog-importer.md`](../../../docs/issues/006-scf-catalog-importer.md)
- Cluster: `catalog`
- Branch: `catalog/006-scf-catalog-importer`
- PRD id: `006-scf-catalog-importer`
