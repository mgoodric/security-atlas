# Slice 022 — Policy entity + version control + 5 stock policies bundled

Copy-paste prompt for executing slice 022. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/022-policy-library.md.

Branch: policies/022-policy-library (from main).
...
Open PR titled "feat(policies): Policy entity + version control + 5 stock policies bundled (#022)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 022-policy-library).
```
...
- Issue file: [`docs/issues/022-policy-library.md`](../../../docs/issues/022-policy-library.md)
- Cluster: `policies`
- Branch: `policies/022-policy-library`
- PRD id: `022-policy-library`
