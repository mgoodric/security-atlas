# Slice 009 — Control bundle format spec + parser + upload API

Copy-paste prompt for executing slice 009. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/009-control-bundle-format.md.

Branch: control-as-code/009-control-bundle-format (from main).
...
Open PR titled "feat(control-as-code): Control bundle format spec + parser + upload API (#009)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 009-control-bundle-format).
```
...
- Issue file: [`docs/issues/009-control-bundle-format.md`](../../../docs/issues/009-control-bundle-format.md)
- Cluster: `control-as-code`
- Branch: `control-as-code/009-control-bundle-format`
- PRD id: `009-control-bundle-format`
