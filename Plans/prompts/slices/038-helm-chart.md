# Slice 038 — Helm chart for K8s deployment

Copy-paste prompt for executing slice 038. See `Plans/prompts/04-per-slice-template.md` for the template that generated this file.

---

```
Build docs/issues/038-helm-chart.md.

Branch: infra/038-helm-chart (from main).
...
Open PR titled "feat(infra): Helm chart for K8s deployment (#038)" with body: AC pass/fail · files changed · CI URL · open questions surfaced.

Use Algorithm mode. Initialize a PRD (id: 038-helm-chart).
```
...
- Issue file: [`docs/issues/038-helm-chart.md`](../../../docs/issues/038-helm-chart.md)
- Cluster: `infra`
- Branch: `infra/038-helm-chart`
- PRD id: `038-helm-chart`
