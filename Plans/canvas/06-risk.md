...
A child risk's lifecycle is independent of its parent: closing all children does not auto-close the parent; the parent represents a _pattern_ that may persist beyond any individual instance.
...
Decisions appear in audit narrative export (§8) as **context**, not as compliance artifacts. An auditor reading the SSP sees: _"This gap exists because of decision DL-2026-04-12: ship MVP, defer X. Linked risk RSK-... accepted by .... Revisit: 2026-07-01."_ The chain is legible.
