...
| **The collector agent on every laptop**                                     | Drata-style endpoint agent for evidence                                                | Customers of security-product companies ask "do you run a vendor's agent?" and the answer matters. We use osquery / Fleet (open) and read-only API integrations. No proprietary agents.                                      |
