...
- **Slice docs:** [`docs/issues/003-evidence-sdk-push.md`](https://github.com/mgoodric/security-atlas/blob/main/docs/issues/003-evidence-sdk-push.md), [`docs/issues/012-eval-engine.md`](https://github.com/mgoodric/security-atlas/blob/main/docs/issues/012-eval-engine.md), [`docs/issues/013-evidence-ledger.md`](https://github.com/mgoodric/security-atlas/blob/main/docs/issues/013-evidence-ledger.md), [`docs/issues/014-schema-registry.md`](https://github.com/mgoodric/security-atlas/blob/main/docs/issues/014-schema-registry.md), [`docs/issues/017-control-effectiveness.md`](https://github.com/mgoodric/security-atlas/blob/main/docs/issues/017-control-effectiveness.md)
