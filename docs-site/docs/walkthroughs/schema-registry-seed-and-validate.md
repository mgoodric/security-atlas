...
- **Slice docs:** [`docs/issues/014-schema-registry.md`](https://github.com/mgoodric/security-atlas/blob/main/docs/issues/014-schema-registry.md) (registry introduced), [`docs/issues/015-redaction-rules.md`](https://github.com/mgoodric/security-atlas/blob/main/docs/issues/015-redaction-rules.md) (`x-redaction-rules` + tenant-private kinds), [`docs/issues/068-schema-registry-evidence-kind-fix.md`](https://github.com/mgoodric/security-atlas/blob/main/docs/issues/068-schema-registry-evidence-kind-fix.md) (retry-with-backoff)
