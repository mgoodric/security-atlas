...
- **Canvas:** [`Plans/canvas/04-evidence-engine.md`](https://github.com/mgoodric/security-atlas/blob/main/Plans/canvas/04-evidence-engine.md) §4 — Evidence SDK + schema registry, §4.5 — `.vN` versioning rule
- **Slice docs:** [`docs/issues/014-schema-registry-service.md`](https://github.com/mgoodric/security-atlas/blob/main/docs/issues/014-schema-registry-service.md) (registry introduced), [`docs/issues/015-nats-jetstream-ingestion-stage.md`](https://github.com/mgoodric/security-atlas/blob/main/docs/issues/015-nats-jetstream-ingestion-stage.md) (`x-redaction-rules` + tenant-private kinds), [`docs/issues/068-schema-registry-evidence-kind-fix.md`](https://github.com/mgoodric/security-atlas/blob/main/docs/issues/068-schema-registry-evidence-kind-fix.md) (retry-with-backoff)
- **Go package:** [`internal/api/schemaregistry/`](https://github.com/mgoodric/security-atlas/blob/main/internal/api/schemaregistry/) — `DefaultSeed`, `LoadFromDB`, `ValidatePayload`, `IsRegisteredForTenant`
