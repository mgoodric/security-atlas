// Slice 445 — vitest coverage for the /api/me/email-channel BFF route.
//
...
describe("GET /api/me/email-channel", () => {
  beforeEach(() => {
    cookieStore.clear();
    vi.restoreAllMocks();
...
describe("PUT /api/me/email-channel", () => {
  ...
  test("returns 401 when session cookie is absent", async () => {
    const req = new Request("http://localhost/api/me/email-channel", {
      method: "PUT",
