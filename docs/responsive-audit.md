...
| `/controls`                                | `no`      | `<ListTable>` with ~7 columns horizontal-scrolls at 375px; primary affordance (anchor click) requires scrolling right to reach. **Priority spillover.**                                                |
...
| `/risks`                                   | `no`      | `<ListTable>` with severity / treatment / owner / age columns horizontal-scrolls at 375px. **Priority spillover.**                                                                                     |
...
| `/evidence`                                | `no`      | List table with provenance / kind / observed_at / actor columns. Same shape as `/controls` and `/risks`. **Priority spillover.**                                                                       |
...
| ------------------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------ |
| [`281`](issues/281-mobile-list-table-collapse.md) | `ready` | Mobile-aware list-table collapse pattern + per-page application to `/controls` + `/risks` + `/evidence` (priority three) |
