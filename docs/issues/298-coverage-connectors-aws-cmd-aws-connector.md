# 298 — Coverage lift — `connectors/aws/cmd/aws-connector` to 70%+
...
- **P0-298-1.** Does NOT raise the `connectors/aws/cmd/aws-connector` floor without writing
  the unit tests that hit the new bar.
- **P0-298-2.** Does NOT lower any existing floor — every change to
  `thresholds` is monotonically ↑.
- **P0-298-3.** Does NOT modify `_STATUS.md` from inside this
