...
**Last reconciled:** 2026-05-21 (batch 88 reconcile · 189 + 193 → merged · spillover 194 ready)
...
| 190 | JWT validation middleware on `/v1/*` + R2 eviction + `/oauth/revoke` + `/oauth/introspect` | `not-ready` | —                                                       | —      | —          | —          | filed 2026-05-21 · auth-substrate-v2 spine slot 4 · Backend/Auth · JUDGMENT · 2-3d · 31 ACs · 11 P0 anti-criteria · CUTOVER SLICE — JWT middleware coexists with slice 034 legacy bearer path; slice 191 retires legacy · ships RFC 7009 revoke + RFC 7662 introspect + oauth_revoked_tokens + sweeper · R2 = pure claim check (eventual eviction; explicit revoke for instant) · load-bearing integration test: AC-25 cross-tenant rejection + revoke-then-reject · gate: 189 merged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
