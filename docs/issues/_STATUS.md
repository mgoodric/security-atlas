...
| 043 | Board pack preview/export view                         | `in-progress` | frontend/043-board-pack-preview-view                    | —      | 2026-05-15 | —          | batch 27 · branch `frontend/043-board-pack-preview-view` · AFK · `web/**` board-pack view · no migration · no spine                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
