...
**Last reconciled:** 2026-05-20 (batch 76 reconcile · 133 → merged · slice 134 ESCALATED + re-scoped to HITL)
...
| 177 | Exceptions list-page UI surface (with slice 138 Export buttons)                       | `not-ready` | —                                                       | —      | —          | —          | filed 2026-05-19 as spillover from slice 138 D6 (no dedicated `/exceptions` list page exists in `(authed)/` at v1; slice 138 backend handler + BFF ship without UI surface); orchestrator-renumbered 176 → 177 due to slot collision with slice 176 (logo theme coupling, PR #386 filed earlier) · frontend · AFK · 0.5d · 6 ACs · gate: slice 138 merged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
