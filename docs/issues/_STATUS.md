...
**Last reconciled:** 2026-05-16 (batch 42 claim-stake · 082 → in-progress)
...
| 082 | Playwright e2e seed-data harness (un-quarantine 079)                   | `in-progress` | infra/082-playwright-seed-data-harness                | —      | 2026-05-16 | —          | batch 42 · AFK · 2-3d · solo-by-design · deps 079 + 069 merged · maintainer staffed 2026-05-16 · ships `seedFromFixture()` harness + wires 5 un-shimmed specs (admin-bootstrap, audit-workspace, control-detail, dashboard, risk-hierarchy) to real Postgres+MinIO+NATS · removes `continue-on-error: true` from `Frontend · Playwright e2e`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
