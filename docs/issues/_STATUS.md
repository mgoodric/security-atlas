...
**Last reconciled:** 2026-05-21 (batch 89 claim-stake · 190 + 194 → in-progress)
...
| 190 | JWT validation middleware on `/v1/*` + R2 eviction + `/oauth/revoke` + `/oauth/introspect` | `in-progress` | backend/190-jwt-middleware                              | —      | 2026-05-21 | —          | filed 2026-05-21 · auth-substrate-v2 spine slot 4 · Backend/Auth · JUDGMENT · 2-3d · 31 ACs · 11 P0 anti-criteria · CUTOVER SLICE — JWT middleware coexists with slice 034 legacy bearer path; slice 191 retires legacy · ships RFC 7009 revoke + RFC 7662 introspect + oauth_revoked_tokens + sweeper · R2 = pure claim check (eventual eviction; explicit revoke for instant) · load-bearing integration test: AC-25 cross-tenant rejection + revoke-then-reject · gate 189 merged at 140b0d1 (batch 88) · batch 89 parallel-pair with 194                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| 194 | CI path filter should include `fixtures/**` so fixture-only PRs trigger Playwright e2e     | `in-progress` | infra/194-ci-fixtures-pathfilter                        | —      | 2026-05-21 | —          | filed 2026-05-21 · spillover from slice 193 · Infra/CI · AFK · 0.25d · 4 ACs · 3 P0 anti-criteria · `.github/workflows/ci.yml` `changes` filter doesn't list `fixtures/**`; fixture-only PRs short-circuit Playwright to stub · ~2-line patch · spec at `docs/issues/194-ci-path-filter-fixtures-coverage.md` · batch 89 parallel-pair with 190                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
