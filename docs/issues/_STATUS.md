...
| 042 | Audit workspace view (sample + walkthrough + comments) | `in-progress` | frontend/042-audit-workspace-view                    | —     | 2026-05-13 | —          | batch 20 (N=2) · AFK · Next.js + shadcn/ui · binds slice 025/026/027/029 backends (auditor period, populations, walkthroughs, audit-notes threads) into auditor workspace                                                                                                 |
