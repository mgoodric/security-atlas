...
**Last reconciled:** 2026-05-13 (batch 20 claim-stake — 042 + 054 → in-progress · 45/63 on main · slice 010 still in-review awaiting HITL signoff)
...
| 010 | SCF-anchored control kit (50 SOC 2 controls)           | `in-review` | control-as-code/010-soc2-control-kit                 | gh#77 | 2026-05-13 | —          | batch 19 (N=3) · 6/6 ACs · 3/3 P0 · 50 YAML bundles + coverage-check script · 43/43 TSC coverage (100%) · HITL signed off by Matt Goodrich 2026-05-13 ("010 looks good") · rebased onto post-batch-20 main                                                                                            |
...
| 042 | Audit workspace view (sample + walkthrough + comments) | `in-review` | frontend/042-audit-workspace-view                    | gh#80 | 2026-05-13 | —          | batch 20 (N=2) · AFK · 7/7 ACs · 3/3 P0 · 32 files ~2.6k lines · BFF proxy + 12 components + Playwright E2E · period-bounded endpoints only (invariant 10) · annotation-draft-store for AC-7 · security review zero findings · orchestrator-closed-out after 2 grill/review stalls                    |
...
| 054 | Declarative aggregation rules engine                   | `in-review` | risk/054-aggregation-rules-engine                    | gh#81 | 2026-05-13 | —          | batch 20 · 10/10 ACs · 6/6 P0 · migration \_026 (3 tables, 4-policy + append-only RLS) · YAML/JSON rule DSL · staged→active activation gate · custom_rego OPA sandbox (capabilities-restricted, no http.send) · cycle-prevention via rule_generated flag · JUDGMENT-type — decisions log not blocking |
...
| --- | --------------------------------- | ------- | ------- | ---------------------------------------------------------------------------------------------- |
| 058 | User docs scaffold + 5 core pages | docs    | 3       | deps 005 + 050 merged · HITL on docs authorship · deferred from batch 20 to avoid 3-HITL stack |

**One slice ready** (058). Slice 010 stays in-review pending your HITL signoff; once 010 merges and slice 054 lands, additional slices unlock (012 → 016/020 → many cascade).

## In-flight (2 worktrees building · 1 slice in-review)

- **010** — `control-as-code/010-soc2-control-kit` · `in-review` since 2026-05-13 · HITL · PR gh#77 CI-green; awaiting Matt's 8-bundle spot-check
- **042** — `frontend/042-audit-workspace-view` · `in-progress` since 2026-05-13 · AFK · binds slice 025/026/027/029 backends · ~2.5d
- **054** — `risk/054-aggregation-rules-engine` · `in-progress` since 2026-05-13 · HITL on rule activation · slot `_026` · ~3d

Stale worktrees still on disk: `-007`, `-008`, `-009`, `-011`, `-013`, `-014`, `-015`, `-017`, `-018`, `-019`, `-021`, `-022`, `-023`, `-024`, `-025`, `-026`, `-028`, `-029`, `-033`, `-034`, `-035`, `-036`, `-039`, `-044`, `-045`, `-046`, `-047`, `-048`, `-049`, `-050`, `-051`, `-052`, `-053`, `-059`, `-060`, `-061`, `-062`. Safe to `git worktree remove` whenever ready.
