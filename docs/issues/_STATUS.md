...
**Last reconciled:** 2026-05-16 (batch 38 · 103 → in-review)

## Drift detected — 2026-05-16 (batch 38 · 103 → in-review)
...
| 107 | `GET /v1/policies?include=ack_rate` extension                       | `in-review`   | backend/107-policies-include-ack-rate                   | gh#239 | 2026-05-16 | —          | batch 38 · backend · AFK · 1d · spillover from 101 · deps 022/023/033 merged · single SQL join (CountFreshAcks + CountRequiredRoleUsers predicates mirrored) under tenancy.ApplyTenant tx · 6 unit tests + 5 integration tests (incl. RLS round-trip + cross-check vs per-policy handler) · frontend hard-codes `?include=ack_rate` on BFF + browser fetchers mirroring slice 104 · CHANGELOG entry under [Unreleased]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
