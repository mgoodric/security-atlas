...
| 068 | `ready` → `in-progress` | batch 26 · branch `evidence-pipeline/068-schema-registry-evidence-kind-fix` · AFK · no migration · ~1-1.5d |
...
| 068 | Schema-registry evidence_kind identifier fix           | `in-progress` | evidence-pipeline/068-schema-registry-evidence-kind-fix | —      | 2026-05-14 | —          | batch 26 · AFK · aligns `DefaultSeed()`'s `.v1`-suffixed kinds with the bare-name convention used by schema dirs + control bundles + evidence-push · fixes fresh-deploy phase-6 control-bundle upload · greens slice 065's AC-12 e2e · no migration · deps 014/010 merged                                                                                                                                                                                                                                                                                             |
