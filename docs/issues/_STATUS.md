...
| 038 | Helm chart for K8s                                     | `in-progress` | infra/038-helm-chart                                    | —      | 2026-05-14 | —          | batch 26 · AFK · `deploy/helm/**` + `.github/workflows/*` (helm lint CI) · leaf slice · no migration · no spine touch · dep 037 merged                                                                                                                                                                                                                                                                                                                                                                                                                                |
