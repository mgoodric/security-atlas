...
**Last reconciled:** 2026-05-22 (batch 101 reconcile · 202 → merged)
...
| 175 | Control bundle history export (lineage including superseded versions)                             | `not-ready`                   | —                                                       | —      | —                   | —          | filed 2026-05-19 as spillover from slice 137 D2 (rejected `superseded_by` / `superseded_at` columns for active-only export) · backend/frontend · AFK · 1d · 7 ACs · provisional — gate is slice 028 audit-period attestation workflow shipping a sample-pull surface that needs lineage view                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
