...
| 037 | docker-compose self-host bundle                        | `in-progress` | infra/037-docker-compose-self-host                   | —     | 2026-05-13 | —          | batch 21 (N=2) · AFK · `deploy/docker/**` + justfile self-host recipes (the batch's one spine touch) · no migrations                                                                                                                                                                                                    |
