...
**Last reconciled:** 2026-05-21 (batch 97 claim-stake · 198 SOLO → in-progress + spec authored)
...
| 198 | OIDC-first-install bootstrap (slice 192 follow-on)                                                | `in-progress`                 | backend/198-oidc-first-install-bootstrap                | —      | —                   | —          | batch 97 · SOLO · spec authored by orchestrator 2026-05-21 · Backend/Auth · AFK · 0.5-1d · 7 ACs · 5 P0s · OIDC callback bootstrap branch (count(\*) FROM tenants == 0 → atomic Default Tenant + super_admin + tenant_admin + user_tenants single transaction) · race-safe via slice 144 LOWER(name) UNIQUE · closes slice 192's AC-11/AC-12                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
