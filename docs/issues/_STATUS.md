...
| 155 | Questionnaire feature design + build (CAIQ/SIG/HECVAT response)                       | `in-progress` | feature/155-questionnaire-tracer                        | —      | 2026-05-20 | —          | **scope locked 2026-05-20 by maintainer to TRACER-BULLET: Excel import only + manual authoring + AnswerLibrary skeleton + PDF export.** CSV / JSON / Word import + HECVAT bundled templates + vendor portal + AI-assist all DEFERRED as spillovers. Estimate trimmed 3-5d → 3-4d AFK-pickable. Load-bearing design call locked: AnswerLibrary keys on SCF anchor IDs (not free-text question strings). Engineer's first step at pickup: deliver `Plans/mockups/questionnaire.html` against locked scope. · filed 2026-05-18 from comprehensive front-end gap audit · backend/frontend · JUDGMENT · canvas §4.6 commits to v1 ship                                                                                                                                                                                                                                                                                                                                                                                                      |
