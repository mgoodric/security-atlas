...
**Last reconciled:** 2026-05-16 (batch 40 claim-stake · 108 → in-progress · last ready slice in queue)
...
| 108 | `/v1/me/*` profile + preferences + sessions endpoints               | `in-progress` | backend/108-me-profile-preferences-sessions             | —      | 2026-05-16 | —          | batch 40 · backend · AFK · 2-3d · spillover from 103 · deps 034 + 109 merged · `GET /v1/me` + `GET/PATCH /v1/me/preferences` + `GET /v1/me/sessions` + `DELETE /v1/me/sessions/{id}` cohesive surface · lands on clean post-109 dbx baseline                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
