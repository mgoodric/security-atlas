...
**Last reconciled:** 2026-05-21 (batch 95 claim-stake · 197 SOLO → in-progress)
...
| 197 | Complete slice 034 bearer-middleware retirement (test-fixture migration + final removal)          | `in-progress`                 | backend/197-complete-bearer-retirement                  | —      | —                   | —          | batch 95 · SOLO · spillover from slice 191 · gates 191 + 196 ✅ both merged · Backend/Auth/Testing · AFK · 2-3d · migrates ~60 integration test fixtures from credstore.Issue() to JWT-bearer-via-tokensign + removes `atlas_test_` carve-out + removes `httpAuthMiddlewareWithExemptions` mount entirely + drops legacy responder narrowing                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
