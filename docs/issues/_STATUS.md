...
**Last reconciled:** 2026-05-21 (batch 93 reconcile · 196 → merged; slice 200 filed)
...
| 200 | Fix self-host bundle external-mode postgres init regression                                       | `ready`                       | —                                                       | —      | —                   | —          | filed 2026-05-21 · spillover from slice 196 · Quality/Infra · JUDGMENT · 0.5d · 6 ACs · root-cause-then-fix the external-mode `test-self-host-bundle.sh` failure surfaced when slice 196's path-filter touches finally triggered the previously-skipped test · failing step: `psql ... FATAL: database "security_atlas" does not exist` at the harness's pre-create logic · hypothesis: empty `POSTGRES_HOST_AUTH_METHOD` short-circuits initdb's POSTGRES_DB step · slice 196 did NOT touch the failing code path                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
