...
| 189 | OAuth `/oauth/authorize` + PKCE + frontend OAuth client integration                        | `in-review` | backend/189-oauth-authorize-pkce                        | gh#447 | 2026-05-21 | —          | filed 2026-05-21 · auth-substrate-v2 spine slot 3 · Backend/Auth + Frontend · JUDGMENT · 2-3d · 26 ACs · 10 P0 anti-criteria · ships `/oauth/authorize` + PKCE S256 (RFC 7636) + auth_code redemption on `/oauth/token` + oauth_auth_codes + oauth_client_redirect_uris + frontend oauth-client.ts + sweeper · open-redirect prevented via registered redirect URI table · PKCE-only browser flow (no implicit grant) · gate 188 merged at c0e7531 (batch 87)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
