...
**Last reconciled:** 2026-05-22 (batch 101 claim-stake · 202 SOLO → in-progress)
...
| 202 | Self-host bundled mode: atlas service starts before migrations finish                             | `in-progress`                 | infra/202-self-host-bundled-bootstrap-race-fix          | —      | —                   | —          | batch 101 · SOLO · spillover from slice 131 PR #484 · infra (self-host) · AFK · 0.5d · bundled-mode atlas/bootstrap race surfaced when path-filter triggered self-host job on slice 131 (pure test-code diff); priority-dropped after PR #485 ran self-host bundled twice CLEAN (timing-flake suspicion) but deterministic-signal gate ships value either way · distinct from slice 200's race (`pg_isready` vs `CREATE DATABASE`); this is `atlas service` vs `atlas-bootstrap migration apply` · 7 ACs · compose/CI shape fix only; no production Go code touched                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
