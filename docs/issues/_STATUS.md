...
| 060 | Admin settings UI (SSO · users · API keys · features)  | `in-review` | frontend/060-admin-settings-ui                       | gh#66 | 2026-05-13 | —          | 10/10 ACs (AC-2, AC-3, AC-6 backend now on main via slice 062; UI shell + wire-shape contracts in this PR — form save-wiring is a follow-up slice) · 5/5 P0 · HITL signed off by Matt Goodrich 2026-05-13 ("60 looks good to me") · rebased onto 1fc5ea5 |
