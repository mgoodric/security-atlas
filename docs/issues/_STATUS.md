...
**Last reconciled:** 2026-05-18 (batch 46 claim-stake · 124 → in-progress)
...
| 124 | Unified audit-log aggregation API                                      | `in-progress` | backend/124-unified-audit-log-aggregation-api           | —      | 2026-05-18 | —          | batch 46 claim-stake · solo-pick · backend (multi-tenancy) · AFK · 2d · 16 ACs · UNION ALL across 9 audit-log tables · `GET /v1/admin/audit-log/unified` · admin OR auditor OPA role gate · 90-day window + 1000-row cursor pagination · idx `(tenant_id, occurred_at DESC)` migration · STRIDE: P0-A4 (no BYPASSRLS) + P0-A5 (no tenant_id param) + AC-3 (tenancy.ApplyTenant) + AC-9 (per-table integration test) are the load-bearing tenant-isolation chain · no deps                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| 120 | Audit and remove phantom (unused) dependencies across all manifests    | `in-review`   | quality/120-phantom-dependencies-audit                  | gh#264 | 2026-05-17 | —          | batch 45 · solo-pick · JUDGMENT · 1-2d · AFK · PR gh#264 · 11/11 ACs PASS · cadence option (b) chosen — new `Deps · phantom audit` informational CI job · removed 2 phantoms (`lucide-react`, `@radix-ui/react-slot`) + 2 KEEP cases documented (`@vitest/coverage-v8`, `react-dom` — peer deps) · mid-flight fix: install ripgrep in CI (runner doesn't pre-bundle) · CONTRIBUTING.md "Phantom dependencies" subsection (deliberately named differently from PR #262's "Dependency hygiene" to avoid rebase collision)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
