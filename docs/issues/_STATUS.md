...
| 012 | Control state evaluation engine                        | `in-progress` | controls/012-control-state-evaluation                | —     | 2026-05-13 | —          | batch 21 (N=2) · AFK · migration slot `_027` · evaluation stage per invariant 2 · critical-path keystone                                                                                                                                                                                                                                                                                                                    |
...
| 037 | docker-compose self-host bundle                        | `in-review`   | infra/037-docker-compose-self-host                   | —     | 2026-05-13 | 2026-05-13 | batch 21 (N=2) · AFK · 7/7 ACs · 4/4 P0 anti-criteria · `deploy/docker/**` (compose + 4 Dockerfiles + bootstrap + .env.example + .dockerignore) + justfile self-host recipes · option-B in-scope Go touch (`/health` route + auth wiring + `ATLAS_BOOTSTRAP_TOKEN` + `bootstrap hash-password`) — slice ACs are the boundary; httpserver.go overlap with 012 is the known-safe mount-append merge · decisions log committed |
...
| --- | --------------------------------- | ------- | ------- | ------------------------------------------------------------------------------------------------------------------ |
| 058 | User docs scaffold + 5 core pages | docs    | 3       | deps 005 + 050 merged · JUDGMENT-type (docs authorship) · skipped from batch 21 (justfile spine conflict with 037) |

**One slice ready** (058). 012 + 037 are in batch 21. 058 is the natural next pick — solo, or paired with whatever 012's merge unblocks.

## In-flight (2 worktrees building)

- **012** — `controls/012-control-state-evaluation` · `in-progress` since 2026-05-13 · AFK · migration slot `_027` · critical-path keystone
- **037** — `infra/037-docker-compose-self-host` · `in-progress` since 2026-05-13 · AFK · `deploy/docker/**` + justfile self-host recipes

Stale worktrees still on disk: `-007`, `-008`, `-009`, `-010`, `-011`, `-013`, `-014`, `-015`, `-017`, `-018`, `-019`, `-021`, `-022`, `-023`, `-024`, `-025`, `-026`, `-027`, `-028`, `-029`, `-033`, `-034`, `-035`, `-036`, `-039`, `-042`, `-044`, `-045`, `-046`, `-047`, `-048`, `-049`, `-050`, `-051`, `-052`, `-053`, `-054`, `-059`, `-060`, `-061`, `-062`, `-063`. Safe to `git worktree remove` whenever ready.
