...
**Last reconciled:** 2026-05-18 (batch 52 claim-stake · 132 + 135 → in-progress · docs refresh + data-export library)

## Drift detected — 2026-05-18 (batch 52 claim-stake · 132 + 135 → in-progress)
...
> _Note: count reflects canonical Status table only. 5 slices merged on `main` (132 doc-PR slices + spillovers in PRs #291/#292/#293) are filed as `docs/issues/*.md` but their canonical rows are added here by this reconcile; previously counted as `merged` based on PR-merge state, the canonical table tracks them now. Earlier count "merged: 126" included those 5 prematurely — corrected here._
...
| 132 | README refresh with fresh screenshots (v1.10.0+ baseline)              | `in-review`   | docs/132-readme-refresh-impl                            | gh#296 | 2026-05-18 | —          | batch 52 · parallel-pair w/ 135 · docs · AFK · 1-2d · 12/12 AC PASS · refresh README + hero + per-page screenshots against v1.10.0+ via hermetic stub-server capture pipeline (D1 chose slice-057 stub-server over docker-compose) · 1.8 MB animated GIF removed (P0-A4 budget) · 288K/2048K total image budget (14% utilization) · 26-case vitest on capture-safety gate (load-bearing P0-A1 + P0-A2 mitigation) · spillover surfaced: BFF cookie regression in production-build standalone (NOT in scope; filed by maintainer as separate slice)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 133 | mkdocs user docs content refresh (slice 058 follow-on)                 | `not-ready`   | —                                                       | —      | —          | —          | filed 2026-05-18 via /idea-to-slice · spillover from 132 · docs · AFK · 2-3d · 8 ACs · per-primitive how-to + audit-log trio guide + CI hardening reference + connector authoring guide · reuses slice-132 screenshot pipeline · gate: 132 merged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 134 | In-app walkthrough refresh (sync with current UI state)                | `not-ready`   | —                                                       | —      | —          | —          | filed 2026-05-18 via /idea-to-slice · spillover from 132 · frontend/docs · AFK · 1-2d · 7 ACs · audits + re-records existing walkthroughs against v1.10.0+ UI; adds walkthroughs for post-027/070 pages · reuses slice-132 capture pipeline + slice-027 recorder · gate: 132 merged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| 135 | Data-export library + audit-log export (CSV / JSON / XLSX)             | `in-progress` | backend/135-data-export-library                         | —      | 2026-05-18 | —          | batch 52 · parallel-pair w/ 132 · backend/frontend · JUDGMENT · 2-3d · 16 ACs · NEW `internal/export/` + 3 encoders + streaming + audit-log ref impl + BFF + Export button · D1-D3 JUDGMENT at pickup (XLSX library lean: handcrafted minimal-XLSX writer; filename convention; 100K row-cap default)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 136 | Risk register data export (CSV / JSON / XLSX)                          | `not-ready`   | —                                                       | —      | —          | —          | filed 2026-05-18 via /idea-to-slice · spillover from 135 · backend/frontend · AFK · 0.5d · reuses slice-135 library · canonical column set excludes treatment_narrative at v1 · gate: 135 merged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 137 | Controls UCF graph data export (CSV / JSON / XLSX)                     | `not-ready`   | —                                                       | —      | —          | —          | filed 2026-05-18 via /idea-to-slice · spillover from 135 · backend/frontend · JUDGMENT · 1d · 9 ACs · lifted row cap 500K · D1 graph projection JUDGMENT (flat vs nested vs two-sheet XLSX) at pickup · streaming-memory test capped at 200 MB · gate: 135 merged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 138 | Ledger entities export (evidence + policies + exceptions + samples)    | `not-ready`   | —                                                       | —      | —          | —          | filed 2026-05-18 via /idea-to-slice · spillover from 135 · backend/frontend · AFK · 1-2d · 20 ACs · 4 endpoints / BFFs / Export buttons / column sets · evidence excludes payload_json at v1 (operational-metadata leak) · samples row cap lifted to 250K · gate: 135 merged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| 139 | Audit periods + vendors data export (CSV / JSON / XLSX)                | `not-ready`   | —                                                       | —      | —          | —          | filed 2026-05-18 via /idea-to-slice · spillover from 135 · backend/frontend · AFK · 0.5-1d · 11 ACs · 2 endpoints / BFFs / Export buttons · audit-period freeze metadata columns included; cosigned bundle bytes NOT included (slice 030's surface) · vendor email masked to `*@domain.tld` at v1 · gate: 135 merged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 140 | OpenAPI 3.1 spec + Redoc UI + drift-detect CI guard                    | `ready`       | —                                                       | —      | —          | —          | filed 2026-05-18 via /idea-to-slice · backend/docs/infra · JUDGMENT · 2-3d · 16 ACs · OpenAPI 3.1 spec from chi handler annotations + Redoc UI in mkdocs Material + BLOCKING `openapi-drift-check` CI guard (slice 128 pattern) · D1 generator choice (swaggo/swag lean) · D2 UI choice (Redoc lean) · D3 drift-guard severity (BLOCKING lean) · 10 P0 anti-criteria · threat model: tampering (drift-detect mandatory) + information-disclosure (`x-internal: true` filter) load-bearing · coordinates with slice 135 via drift-detect guard · deps satisfied (003 + 058 + 127 + 128 merged)                                                                                                                                                                                                                                                                                                                                                                                                                                          |
