...
**Last reconciled:** 2026-05-16 (batch 39 claim-stake · 109 → in-progress · solo for sqlc regen-conflict safety)
...
| 109 | sqlc toolchain pin + regen reset                                    | `in-progress` | infra/109-sqlc-toolchain-pin                            | —      | 2026-05-16 | —          | batch 39 · infra · AFK · 0.25d · solo (108 deferred to next batch — both modify internal/db/dbx/\*) · pin sqlc version in justfile + regen reset + CLAUDE.md/CONTRIBUTING.md update + optional drift-check CI                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
