...
| 029 | Audit Hub threaded comments                            | `in-progress` | audit/029-audit-hub-comments                         | —      | 2026-05-13 | —          | batch 18 (N=2) · AFK · migration slot \_023 · extends slice 025 audit_notes (parent_note_id + visibility CHECK swap + notifications)                                                                                        |
...
| 062 | Admin BFF backend endpoints (SSO + Users + audit-log)  | `in-review`   | admin/062-admin-bff-backend-endpoints                | gh#TBD | 2026-05-13 | —          | batch 18 (N=2) · AFK · migration slot \_022 (admin_audit_log_v view) · `/v1/admin/sso` + users + audit-log · 10/10 ACs PASS · 5/5 P0 anti-criteria PASS · awaiting CI green · unblocks slice 060 final merge                |
