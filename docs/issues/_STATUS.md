...
**Last reconciled:** 2026-05-21 (batch 87 claim-stake · 111 + 188 → in-progress)
...
| 111 | Enable full assertions in `dashboard.spec.ts`                                              | `in-review` | quality/111-dashboard-spec-full-assertions              | gh#441 | 2026-05-21 | —          | spillover from 082 (orchestrator-filed · Amendment 2) · AFK · 0.25d · **gate satisfied 2026-05-21**: 56 consecutive clean post-082 runs of `Frontend · Playwright e2e` confirmed (last failure 2026-05-20T01:46:19Z on slice 172 — pre-082-soak-gate-resume) · dashboard.sql already FULL — pure un-skip work                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| 188 | OAuth `/oauth/token` endpoint + RFC 8693 token exchange                                    | `in-review` | backend/188-oauth-token-endpoint                        | gh#442 | 2026-05-21 | —          | filed 2026-05-21 · auth-substrate-v2 spine slot 2 · Backend/Auth · JUDGMENT · 2-3d · 25/25 ACs · 11/11 P0 anti-criteria honored · 18 files / +2589 / engineer ~70 min wall-clock · D1 argon2id reuses `password.Hash` (m=64MiB/t=1/p=4 RFC 9106) · D2 custom `atlas:target_tenant_id` form param (not RFC 8693 actor_token — capability swap vs delegation) · D3 audit log best-effort post-sign (safety enforced before write) · D4 60/min/client_id rate limit · threat-model has-mitigations (5 STRIDE categories covered)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
