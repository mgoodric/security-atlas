...
| 192 | Multi-tenant switch via OAuth token-exchange + frontend tenant switcher (closes slice 141)        | `in-review` | backend/192-multi-tenant-switch                         | gh#458 | 2026-05-21 | —          | filed 2026-05-21 · auth-substrate-v2 spine slot 6 (FINAL) · Backend/Auth + Frontend · JUDGMENT · 2-3d · 23/23 ACs · 11/11 P0 anti-criteria honored · CLOSES slice 141 vCISO criterion via OAuth token-exchange · D1 60s cache · D2 inline banner · D3 prompt=tenant only-when-≥2 · D4 merged-via-spine-completion status · spillovers 198 (OIDC-first-install bootstrap) + 199 (cross-tab BroadcastChannel) · downstream re-eval: 142 stays not-ready (re-scope), 143 gated on 142, 144 → ready                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
