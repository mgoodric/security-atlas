...
**Last reconciled:** 2026-05-21 (batch 95 reconcile · 197 → merged UNSTABLE; slice 201 filed)
...
| 201 | Migrate Playwright e2e fixtures from slice 034 bearer to JWT-via-tokensign                        | `ready`                       | —                                                       | —      | —                   | —          | filed 2026-05-21 · spillover from slice 197 · Quality/Backend/Auth · AFK · 0.5-1d · 8 ACs · 4 P0s · `web/e2e/seed.ts:53` defines `TEST_BEARER = "test-bearer-e2e"` (slice 034 bearer) — broken by slice 197's middleware removal · candidate shape: in-process global-setup helper calling NEW `POST /v1/test/issue-jwt` endpoint env-gated by `ATLAS_TEST_MODE=1` · `Frontend · Playwright e2e` is NOT branch-protection-required (slice 127); merge held until 4-spec cluster (slice 123) plus this work lands                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
