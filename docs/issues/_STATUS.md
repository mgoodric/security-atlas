...
| 056 | Hierarchical risk dashboard view                       | `in-progress` | frontend/056-hierarchical-risk-dashboard             | —      | 2026-05-14 | —          | batch 24 · AFK · `web/**`-only · three-panel view (org tree · theme heatmap · decision timeline) · deps 005/053/054/055 merged                                                                                                                                                                                                                                                                                                                         |
