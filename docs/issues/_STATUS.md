...
**Last reconciled:** 2026-05-20 (continuous-loop batch 82 claim-stake · 183 + 186 → in-progress)
...
| 084 | cosign v3 + goreleaser-action v7 coordinated migration                                | `ready`       | —                                                       | —      | —          | —          | **maintainer green-lit 2026-05-20** — no real users yet → no release-window blast-radius concern → proceed as solo iteration · v2 backlog · AFK · ~0.5d · originally gated on Dependabot surfacing both bumps; gate cleared by maintainer (we're upgrading directly) · still requires `signs:` args rework in `.goreleaser.yaml` · push a `v0.0.0-slice084-test` tag as round-trip fixture · spillover from batch 30 (renumbered from 082)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| 183 | UI honesty: calendar `linkFor` dead-link family + dashboard mockup refresh            | `in-progress` | frontend/183-calendar-deadlinks-and-dashboard-mockup    | —      | 2026-05-20 | —          | claimed batch 82 by continuous-loop engineer (AFK, 0.5-1d); branch cut from `dbef2f6`; spillover from slice 178 F-178-1/2/3 + F-178-7/8 (batched) · 7 ACs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| 186 | UI honesty: sidebar Admin entry shown to non-admin                                    | `in-progress` | frontend/186-sidebar-admin-role-gate                    | —      | 2026-05-20 | —          | claimed batch 82 by continuous-loop engineer (AFK, 0.25d); branch cut from `dbef2f6`; spillover from slice 178 F-178-6 · 4 ACs · role-gate via slice 035 OPA pattern                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
