...
| 016 | Evidence freshness + drift detection                   | `in-progress` | evidence/016-evidence-freshness-drift                | —     | 2026-05-14 | —          | batch 22 (N=3) · AFK · migration slot `_028` · freshness/drift materialized read-model over the evidence ledger                                                                                                                                                                                                         |
