...
| 020 | Risk → control linkage + residual derivation           | `in-progress` | risk/020-risk-control-linkage-residual               | —     | 2026-05-14 | —          | batch 22 (N=3) · AFK · migration slot `_029` (`risk_control_links`) · residual = inherent × (1 − weighted effectiveness) · NATS recompute-on-control-state-change                                                                                                                                                       |
