...
| 172 | MCP server foundation + read-only tools                                               | `ready`     | —                                                       | gh#380 | —          | —          | filed 2026-05-19 via /idea-to-slice from maintainer feature ask · doc landed via PR #380 at `278ade9` · backend/infra · JUDGMENT · 3-4d · 18 ACs · 13 P0 anti-criteria · STRIDE has-mitigations · stdio transport; bearer auth via env; 6 read tools (controls/control/risks/risk/evidence/audit_periods) · cmd/atlas-mcp/ new build target · pre-boundary (no audit-binding writes) · deps merged (003 + 034 + 145)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
