...
**Last reconciled:** 2026-05-21 (batch 96 reconcile · 201 → merged after 2-iteration fix)
...
| 198 | OIDC-first-install bootstrap (slice 192 follow-on)                                                | `ready`                       | —                                                       | —      | —                   | —          | filed 2026-05-21 · spillover from slice 192 · Backend/Auth · AFK · 0.5-1d · OIDC callback handler extension for first-install scenario (`count(*) FROM tenants == 0` → create "Default Tenant" + grant super_admin + tenant_admin atomically); slice 192's AC-11/12 deferred to here per partial-cutover-with-spillover pattern (191 D6 precedent)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
