...
**Last reconciled:** 2026-05-21 (batch 89 reconcile · 190 + 194 → merged · spine 4/6 complete)
...
| 191 | SDK migration to `client_credentials` × 4 languages + CLI device-code + legacy retirement  | `not-ready` | —                                                       | —      | —          | —          | filed 2026-05-21 · auth-substrate-v2 spine slot 5 · Backend/SDK/CLI · JUDGMENT · 3-4d · 36 ACs · 11 P0 anti-criteria · RFC 8628 device-code flow + Go/Python/TS OAuth clients + `atlas login` device-code CLI + `atlas oauth migrate-api-key` + RETIRES slice 034 bearer middleware + 410 Gone deprecation responder · Java SDK may be spillover if `sdk/java/` doesn't exist · credstore package retirement deferred to v3 · gate: 190 merged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
