...
| 041 | Control detail view + UCF mini-viz                     | `in-progress` | frontend/041-control-detail-view                     | —     | 2026-05-14 | —          | batch 22 (N=3) · AFK · `web/app/controls/[id]/**` + UCF mini-viz SVG · pure frontend, no migration, no Go-backend                                                                                                                                                                                                       |
