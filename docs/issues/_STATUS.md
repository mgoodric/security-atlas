...
**Last reconciled:** 2026-05-21 (batch 93 claim-stake · 196 SOLO → in-progress)
...
| 196 | Bootstrap OAuth migration (atlas-bootstrap container → client_credentials)                        | `in-progress`                 | infra/196-bootstrap-oauth-migration                     | —      | —                   | —          | batch 93 · SOLO · spillover from slice 191 · Infra/Bootstrap · AFK · 1d · 7 ACs · migrates atlas-bootstrap container's `atlas-cli controls upload` from slice 034 credstore bearer (gone after 191 cutover) to OAuth client_credentials issued at container startup · uses slice 191 Go SDK oauth helper; self-host bundle e2e is the load-bearing verification                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
