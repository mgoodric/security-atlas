...
| 135 | Data-export library + audit-log export (CSV / JSON / XLSX)             | `in-review` | backend/135-data-export-library                         | gh#297 | 2026-05-18 | —          | batch 52 · parallel-pair w/ 132 · backend/frontend · JUDGMENT · 2-3d · 16/16 AC PASS · D1 picked option (c) handcrafted minimal-XLSX writer (~200 LOC, zero new deps, P0-A6 by construction) · D2 sorted-KV filename · D3 100K default cap · 10 JUDGMENT calls D1-D10 (incl D6 SQL CASE-WHEN hardening + D7 audit-period freeze clamp + D8 distinct meta-audit action) · cross-tenant isolation tests × 3 formats · OPA admit-set parity (6 roles × 2 endpoints) · zero spillovers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
