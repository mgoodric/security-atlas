...
| 132 | README refresh with fresh screenshots (v1.10.0+ baseline)              | `in-progress` | docs/132-readme-refresh-impl                            | —      | 2026-05-18 | —          | batch 52 · parallel-pair w/ 135 · docs · AFK · 1-2d · 12 ACs · refresh README + hero + per-page screenshots against v1.10.0+ via Playwright capture pipeline against demo seed · triggered by maintainer 2026-05-18 v1.9 login-page broken-logo report (fixed by slice 123) · threat model: information-disclosure load-bearing (P0-A1-A4 merge-blocking)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
