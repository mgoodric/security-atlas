...
**Last reconciled:** 2026-05-16 (batch 37 merged · 099/101/105 on main + 106/107 spillovers ready · 100/106 slices on main · slice-093 UI fill-in suite COMPLETE)
...
| 106 | `GET /v1/evidence` extension (control_id optional + filters)        | `ready`     | —                                                       | —      | —          | —          | spillover from 099 · backend · ~1d · AFK · deps 013/016/033 merged · makes `control_id` query param optional + adds `?kind=`/`?result=`/`?source_actor_*=` filters + surfaces `result` field on `evidenceWire` (currently only on PUSH `recordWire`) · unblocks slice-099's `—` placeholder in the result column                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 107 | `GET /v1/policies?include=ack_rate` extension                       | `ready`     | —                                                       | —      | —          | —          | spillover from 101 · backend · ~1d · AFK · deps 022/023/033 merged · adds `?include=ack_rate` query param to `/v1/policies` returning per-row ack-rate cell in one round-trip · mirrors slice 104 shape · unblocks slice-101's `—` placeholder in the acknowledgment column                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
