...
**Last reconciled:** 2026-05-20 (post-batch-76 row-flips · 176 canonical row added · 177 → ready)
...
| 176 | Logo follows app theme + README/docs refresh                                          | `ready`       | —                                                       | gh#386 | —          | —          | filed 2026-05-19 via /idea-to-slice from maintainer report (light logo invisible on light bg); doc landed via PR #386 at `5e33027` · Frontend + Docs · AFK · 0.5d · 15 ACs · 10 P0 anti-criteria · Bug A: `<picture>` uses prefers-color-scheme (OS) not app theme (slice 170's persisted state); Bug B: docs/images/logo-\*.png are pre-slice-167 stale · deps merged (#167 logo design + #170 theme hydration)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 177 | Exceptions list-page UI surface (with slice 138 Export buttons)                       | `in-progress` | frontend/177-exceptions-list-page                       | —      | 2026-05-20 | —          | claimed 2026-05-20 by continuous-loop engineer (AFK, 0.5d); branch `frontend/177-exceptions-list-page` cut from `aabec13`; surfaces `/exceptions` list view consuming `GET /v1/exceptions` (existing) + slice 138 export BFF at `/api/admin/exceptions/export` · frontend · AFK · 0.5d · 6 ACs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
