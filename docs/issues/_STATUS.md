...
| 069 | Verification suite (Playwright + vitest + Go coverage) | `in-progress` | infra/069-verification-suite                            | —      | 2026-05-15 | —          | batch 27 · branch `infra/069-verification-suite` · AFK · `web/package.json` spine touch (devDeps) + `.github/workflows/ci.yml` + `.github/branch-protection.json` + `cmd/scripts/coverage-*` · no migration                                                                                                                                                                                                                                                                                                                                                                                                                                        |
