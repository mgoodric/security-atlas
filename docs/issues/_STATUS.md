...
| 125 | Frontend `/audit-log` page                                             | `in-progress` | frontend/125-audit-log-page                             | —      | 2026-05-18 | —          | deps satisfied 2026-05-18 (124 merged) · filed 2026-05-17 via /idea-to-slice · spillover from 124 · frontend · AFK · 1-2d · gated on 124 · consumes `GET /v1/admin/audit-log/unified` · filters (from/to/actor/kind) + cursor infinite-scroll + admin route guard + BFF route + Playwright e2e                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
