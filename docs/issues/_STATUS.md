...
| 099 | /evidence list view (per slice 093 mockup)                          | `in-progress` | frontend/099-evidence-list-view                         | —      | 2026-05-16 | —          | batch 37 · AFK · 1-2d · deps 093/005/013/016/098 all merged · consumes `GET /v1/evidence?control_id=&kind=&result=&since=` · reuses 098's shell · 8-char hash prefix with copy-on-click · spillover candidate: backend `?include=` extension                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
