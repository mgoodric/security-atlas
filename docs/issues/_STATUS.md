...
**Last reconciled:** 2026-05-20 (batch 81 reconcile · 184 + 185 → merged · parallel pair)
...
| 183 | UI honesty: calendar `linkFor` dead-link family + dashboard mockup refresh            | `ready`     | —                                                       | —      | —          | —          | filed 2026-05-20 as spillover from slice 178 first-pass audit (F-178-1/2/3 calendar dead-link family + F-178-7/8 dashboard mockup-stale refresh; batched per the trivial-doc-only batch rule) · Frontend · AFK · 0.5-1d · 7 ACs · honest-UI principle: live calendar must not link to routes that don't exist + dashboard mockup must reflect actually-shipped state                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| 186 | UI honesty: sidebar Admin entry shown to non-admin                                    | `ready`     | —                                                       | —      | —          | —          | filed 2026-05-20 as spillover from slice 178 first-pass audit (F-178-6) · Frontend · AFK · 0.25d · 4 ACs · sidebar shows Admin nav entry to all callers; should be role-gated to admin-only (already a slice-035 OPA pattern available)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
