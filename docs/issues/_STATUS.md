...
**Last reconciled:** 2026-05-22 (batch 99 reconcile · 143 → merged)
...
| 202 | Self-host bundled mode: atlas service starts before migrations finish                             | `ready`                       | —                                                       | —      | —                   | —          | spillover from slice 131 PR #484 · infra (self-host) · AFK · 0.5d · bundled-mode atlas/bootstrap race surfaced when path-filter triggered self-host job on slice 131 (pure test-code diff) · distinct from slice 200's race (`pg_isready` vs `CREATE DATABASE`); this is `atlas service` vs `atlas-bootstrap migration apply` · 7 ACs · compose/CI shape fix only; no production Go code touched                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
