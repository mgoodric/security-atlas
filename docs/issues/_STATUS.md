...
| 126 | External audit-log sink (tamper-evident retention)                     | `in-progress` | infra/126-external-audit-log-sink                       | —      | 2026-05-18 | —          | deps satisfied 2026-05-18 (124 + 121 merged) · filed 2026-05-17 via /idea-to-slice · spillover from 124 · infra (observability) · JUDGMENT · 1.5d · gated on 124 (+ 121 if option (c) picked) · engineer picks 1 of 4 sink mechanisms (JSONL/syslog/OTel-via-collector/S3-cosign) · maintainer's lean = OTel logs via Collector · async fan-out from every domain audit-log INSERT · backpressure to fallback table (no silent drops) · per-record integrity proof                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
