...
**Last reconciled:** 2026-05-22 (batch 102 claim-stake · 116 + 175 PARALLEL → in-progress)
...
| 116 | Promote `Frontend · Playwright e2e` to required-checks                                            | `in-progress`                 | infra/116-promote-playwright-required-check             | —      | —                   | —          | batch 102 · PARALLEL with 175 · spillover from 082 AC-5 · AFK · 0.25d · flips `.github/branch-protection.json` + removes stub-twin job · soak gate met across 142/143/198/201/202                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| 175 | Control bundle history export (lineage including superseded versions)                             | `in-progress`                 | backend/175-control-bundle-history-export               | —      | —                   | —          | batch 102 · PARALLEL with 116 · spillover from 137 D2 · backend + frontend · AFK · 1d · 7 ACs · NEW `GET /v1/controls/history/export` endpoint (17 columns: 137's 15 + `superseded_by` + `superseded_at`) + BFF route + Export button + cross-tenant isolation + streaming-memory test                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
