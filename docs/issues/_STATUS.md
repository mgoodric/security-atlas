...
**Last reconciled:** 2026-05-20 (tier A+B maintainer decisions · 084 + 155 + 174 → ready · 141 pre-confirm)
...
| 179 | `schema-removal-age` CI check (enforce 90-day deprecation window)                     | `ready`     | —                                                       | —      | —          | —          | filed 2026-05-20 as implementation half of OQ #9 + #17 resolution · Infra / Quality · AFK · 0.5d · 13 ACs · 7 P0 anti-criteria · threat-model verdict: has-mitigations · introduction date read from `git log` on main (P0-179-1); `[deprecation-override]` label as escape-hatch; OpenTelemetry semantic-conventions pattern verbatim · companion to slice 014's `additive.go` + `semver.go`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
