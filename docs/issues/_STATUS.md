...
| 054 | Declarative aggregation rules engine                   | `in-progress` | risk/054-aggregation-rules-engine                    | —     | 2026-05-13 | —          | batch 20 (N=2) · HITL on rule activation · migration slot \_026 · rule-DSL + scheduler · binds slice 052/053 (risk hierarchy + themes)                                                                                                                                             |
