...
| 173 | MCP server write tools (create / update operations)                                   | `ready`     | —                                                       | gh#380 | —          | —          | gate cleared 2026-05-19 by slice 172 merge at `95dd94d` (batch 73) · spillover from 172 · backend/infra · JUDGMENT · 3-5d · skeleton 16 ACs · preliminary STRIDE = HOLD-pending-review (re-run at pickup) · MCP write tools + HITL approval flow integration per CLAUDE.md "AI-assist boundary" · 3 viable HITL patterns documented (draft-then-confirm / shadow-table / co-sign-at-tool-time)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
