...
**Last reconciled:** 2026-05-19 (batch 74 reconcile · 137 → merged · controls UCF graph export)
...
| 138 | Ledger entities export (evidence + policies + exceptions + samples)                   | `in-progress` | backend/138-ledger-entities-export                      | —      | 2026-05-19 | —          | claim-staked 2026-05-19 · spillover from 135 · backend/frontend · AFK · 1-2d · 20 ACs · 4 endpoints / BFFs / Export buttons / column sets · evidence excludes payload_json at v1 (operational-metadata leak) · samples row cap lifted to 250K · dep #135 merged at `6d4d2a0`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
