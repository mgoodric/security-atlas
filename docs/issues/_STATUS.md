...
**Last reconciled:** 2026-05-16 (batch 37 claim-stake · 099/101/105 → in-progress)
...
| 105 | Risk-create UI for /risks empty-state CTA (follow-on to slice 100)  | `in-progress` | frontend/105-risk-create-ui                           | —      | 2026-05-16 | —          | batch 37 · frontend · 1-2d · AFK · deps 019/100 merged · risk-create form at `web/app/(authed)/risks/new/` + POST handler on existing 100-merged `web/app/api/risks/route.ts` · re-points 100's empty-state CTA from `/admin` to `/risks/new`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
