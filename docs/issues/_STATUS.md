...
**Last reconciled:** 2026-05-17 (batch 44 claim-stake · 117 → in-progress)
...
| 120 | Audit and remove phantom (unused) dependencies across all manifests    | `ready`       | —                                                       | —      | —          | —          | surfaced via `/loop dep-review` of PR #154 · quality (CI hygiene) · JUDGMENT · 1-2d · AFK · ships `scripts/audit-deps.sh` (USED / USED-VIA-CONFIG / USED-VIA-SCRIPT / PHANTOM classifier) + initial removal pass (one commit per ecosystem) + recurring-cadence mechanism (engineer's JUDGMENT among 4 options; maintainer's lean = PR-comment CI check on manifest changes) · 11 ACs · threat model with config-allowlist mitigation (P0-A4 load-bearing — don't nuke eslint/postcss plugins) · no deps                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
