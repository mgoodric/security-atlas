...
**Last reconciled:** 2026-05-16 (slice 082 maintainer-staffed → `ready` · v2 vacuum exited)
...
| 082 | Playwright e2e seed-data harness (un-quarantine 079)                   | `ready`     | —                                                       | —      | —          | —          | v2 backlog · AFK · ~2-3d · deps 079 + 069 merged · **maintainer staffed 2026-05-16** · removes `continue-on-error: true` from `Frontend · Playwright e2e` once `seedFromFixture()` harness wires 5 un-shimmed specs to a real Postgres+MinIO+NATS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
