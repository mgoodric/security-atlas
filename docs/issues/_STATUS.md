...
| 031 | Monthly board brief (templated, no LLM)                | `in-progress` | board/031-monthly-board-brief                        | —      | 2026-05-14 | —          | batch 24 · AFK · migration slot `_031` (board-brief pinned snapshot) · templated PDF/MD · deps 012/016/020 merged                                                                                                                                                                                                                                                                                                                                      |
...
| 066 | Dashboard backend read endpoints                       | `in-progress` | catalog/066-dashboard-backend-endpoints              | —      | 2026-05-14 | —          | batch 24 · AFK · no migration · fills slice 040's 4 placeholders: per-framework posture (`GET /v1/frameworks/posture`), activity-stream archive (`GET /v1/activity`), `sort=residual,age` on `GET /v1/risks`, unified upcoming-rollup · deps 008/012/015/016/019/021/023/024/028 merged · 041→064 pattern                                                                                                                                              |
