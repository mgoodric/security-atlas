...
| 194 | CI path filter should include `fixtures/**` so fixture-only PRs trigger Playwright e2e     | `in-review`   | infra/194-ci-fixtures-pathfilter                        | gh#450 | 2026-05-21 | —          | filed 2026-05-21 · spillover from slice 193 · Infra/CI · AFK · 0.25d · 4 ACs · 3 P0 anti-criteria · `.github/workflows/ci.yml` `changes` filter doesn't list `fixtures/**`; fixture-only PRs short-circuit Playwright to stub · ~2-line patch · spec at `docs/issues/194-ci-path-filter-fixtures-coverage.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
