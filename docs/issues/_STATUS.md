...
| 187 | OAuth AS scaffolding — JWT signing + JWKS + OIDC discovery                            | `in-progress` | backend/187-oauth-as-scaffolding                        | —      | 2026-05-20 | —          | filed 2026-05-20 as foundation slice for the auth-substrate-v2 spine (OQ #21 Reading D resolution) · Backend/Auth · JUDGMENT · 2-3d · 20 ACs · 11 P0 anti-criteria · threat-model verdict: has-mitigations · ships keystore + tokensign packages + JWKS endpoint + OIDC discovery doc + JWT claim types + ADR-0003 · spine continues: 188 (`/oauth/token` + token-exchange) · 189 (PKCE + frontend OAuth) · 190 (JWT validation middleware + R2 + revocation) · 191 (SDK migration ×4 + CLI device-code) · 192 (multi-tenant switch via token-exchange; closes slice 141 success criterion)                                                                                                                                                                                                                                                                                                                                                                                                                                            |
