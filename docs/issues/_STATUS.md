...
| 188 | OAuth `/oauth/token` endpoint + RFC 8693 token exchange                                    | `in-progress` | backend/188-oauth-token-endpoint                        | —      | 2026-05-21 | —          | filed 2026-05-21 · auth-substrate-v2 spine slot 2 · Backend/Auth · JUDGMENT · 2-3d · 25 ACs · 11 P0 anti-criteria · ships `client_credentials` grant + token-exchange (RFC 8693) + oauth_clients + oauth_token_exchanges audit · per-client rate limit · NEVER elevates super_admin via exchange · `atlas oauth issue-client` CLI helper · deps: 187 merged · D1 argon2id params · D2 target_tenant_id form param shape · D3 audit log write semantics · D4 rate-limit default                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
