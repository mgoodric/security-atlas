...
**Last reconciled:** 2026-05-19 (slices 172 + 173 filed · MCP server foundation + write spillover)

## Drift detected — 2026-05-19 (slices 172 + 173 filed via /idea-to-slice)

Maintainer feature ask: "add an MCP server component that allows me to both read data out of this system and update/create data in the system." Decomposed into two tracer-bullet slices:

- **172** (ready, JUDGMENT, 3-4d): MCP server foundation + 6 read-only tools (list_controls, get_control, list_risks, get_risk, list_evidence, list_audit_periods). Stdio transport; bearer auth; cmd/atlas-mcp/ binary. 18 ACs · 13 P0 anti-criteria. Threat model verdict: has-mitigations.
- **173** (not-ready, gated on 172, JUDGMENT, 3-5d): MCP write tools (create_risk, update_control_state, push_evidence, update_risk_treatment) + HITL approval flow per CLAUDE.md "AI-assist boundary". Preliminary threat model: HOLD-pending-review — fresh STRIDE at pickup. Three HITL approval-flow patterns documented for maintainer pick at design-grill.

Both slices respect the constitutional AI-assist boundary: reads are pre-boundary; writes require one-click human approval before audit-binding artifacts commit (schema-level enforcement: `ai_assisted=true ↔ human_approver` invariant).

| Row | Transition          | Evidence                                                                                                                                                                                                                      |
| --- | ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 172 | (new) → `ready`     | slice doc filed 2026-05-19 via /idea-to-slice; backend/infra · JUDGMENT · 3-4d · MCP server foundation + 6 read tools; STRIDE has-mitigations; 13 P0 anti-criteria; no deps unmet (#003 + #034 + #145 all merged, #138 ready) |
| 173 | (new) → `not-ready` | slice doc filed 2026-05-19 via /idea-to-slice; spillover from 172; backend/infra · JUDGMENT · 3-5d · MCP write tools + HITL approval flow; preliminary STRIDE = HOLD-pending-review; gate: 172 merged                         |

**Counts delta:** new ready +1 (172) · new not-ready +1 (173).
...
| 172 | MCP server foundation + read-only tools                                               | `ready`       | —                                                       | gh#380 | —          | —          | filed 2026-05-19 via /idea-to-slice from maintainer feature ask · backend/infra · JUDGMENT · 3-4d · 18 ACs · 13 P0 anti-criteria · STRIDE has-mitigations · stdio transport; bearer auth via env; 6 read tools (controls/control/risks/risk/evidence/audit_periods) · cmd/atlas-mcp/ new build target · pre-boundary (no audit-binding writes) · deps merged (003 + 034 + 145; 138 ready)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 173 | MCP server write tools (create / update operations)                                   | `not-ready`   | —                                                       | gh#380 | —          | —          | filed 2026-05-19 via /idea-to-slice as spillover from 172 · backend/infra · JUDGMENT · 3-5d · skeleton 16 ACs · preliminary STRIDE = HOLD-pending-review (re-run at pickup) · MCP write tools + HITL approval flow integration per CLAUDE.md "AI-assist boundary" · 3 viable HITL patterns documented for design-grill (draft-then-confirm / shadow-table / co-sign-at-tool-time) · gate: 172 merged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
