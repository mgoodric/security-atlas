...
**Last reconciled:** 2026-05-16 (batch 36 merged · 100/102/104 on main + 105 spillover ready · 97/104 slices on main)
...
| 105 | Risk-create UI for /risks empty-state CTA (follow-on to slice 100)  | `ready`     | —                                                       | —      | —          | —          | spillover from 100 · frontend · 1-2d · AFK · deps 019/100 merged · risk-create form for the /risks page's empty-state CTA (currently routes to /admin as a placeholder)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
