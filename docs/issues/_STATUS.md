...
| 010 | SCF-anchored control kit (50 SOC 2 controls)           | `in-progress` | control-as-code/010-soc2-control-kit                 | —     | 2026-05-13 | —          | batch 19 (N=3) · HITL on 50-control accuracy · 50 YAML bundles + review log · no migrations · no Go code                                                                                                                                                                           |
