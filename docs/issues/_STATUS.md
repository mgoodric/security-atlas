...
**Last reconciled:** 2026-05-21 (batch 96 claim-stake · 201 SOLO → in-progress)
...
| 201 | Migrate Playwright e2e fixtures from slice 034 bearer to JWT-via-tokensign                        | `in-progress`                 | quality/201-playwright-jwt-migration                    | —      | —                   | —          | batch 96 · SOLO · spillover from slice 197 · Quality/Backend/Auth · AFK · 0.5-1d · 8 ACs · 4 P0s · candidate shape: in-process global-setup helper calling NEW `POST /v1/test/issue-jwt` endpoint env-gated by `ATLAS_TEST_MODE=1`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
