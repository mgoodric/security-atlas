...
| 145 | Data-export hardening (payload_json redaction + concurrency cap)                      | `in-progress` | backend/145-data-export-hardening                       | —      | 2026-05-19 | —          | flipped 2026-05-19 via /status-reconcile · from retro-STRIDE on slice 135 · backend · AFK · 0.5d · adds `?include_payload=<bool>` flag (default true preserves backwards-compat) + per-(tenant, user) concurrency cap (default 2; 429 with Retry-After) · dep #135 merged at `6d4d2a0`; coordinate with 136-139 (per-entity exports inherit both behaviors) · claim-staked 2026-05-19 off `f1cae0d`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
