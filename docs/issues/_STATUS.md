...
**Last reconciled:** 2026-05-21 (batch 90 claim-stake · 191 SOLO → in-progress)
...
| 191 | SDK migration to `client_credentials` × 4 languages + CLI device-code + legacy retirement  | `in-progress` | backend/191-sdk-migration-legacy-retirement             | —      | 2026-05-21 | —          | filed 2026-05-21 · auth-substrate-v2 spine slot 5 · Backend/SDK/CLI · JUDGMENT · 3-4d · 36 ACs · 11 P0 anti-criteria · RFC 8628 device-code flow + Go/Python/TS OAuth clients + `atlas login` device-code CLI + `atlas oauth migrate-api-key` + RETIRES slice 034 bearer middleware + 410 Gone deprecation responder · Java SDK may be spillover if `sdk/java/` doesn't exist · credstore package retirement deferred to v3 · gate 190 merged at 3df5df1 (batch 89) · batch 90 SOLO claim                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 192 | Multi-tenant switch via OAuth token-exchange + frontend tenant switcher (closes slice 141) | `not-ready`   | —                                                       | —      | —          | —          | filed 2026-05-21 · auth-substrate-v2 spine slot 6 (FINAL) · Backend/Auth + Frontend · JUDGMENT · 2-3d · 23 ACs · 11 P0 anti-criteria · CLOSES slice 141 vCISO criterion (switch tenants mid-session without re-auth) · ships `<TenantSwitcher>` component + `GET /v1/me/tenants` + login picker for ≥2 tenants + bootstrap branch (first-install creates Default Tenant + grants super_admin) + membership-removed UX banner · HIDDEN when tenant_count==1 (canvas §11 #13) · honest eventual-eviction semantics documented · gate: 191 merged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
