...
**Last reconciled:** 2026-05-19 (batch 73 reconcile · 172 → merged · MCP server foundation shipped)
...
| 137 | Controls UCF graph data export (CSV / JSON / XLSX)                                    | `in-progress` | backend/137-controls-ucf-graph-export                   | —      | 2026-05-19 | —          | claim-staked 2026-05-19 · spillover from 135 · backend/frontend · JUDGMENT · 1d · 9 ACs · lifted row cap 500K · D1 graph projection JUDGMENT (flat vs nested vs two-sheet XLSX) at pickup · streaming-memory test capped at 200 MB · dep #135 merged at `6d4d2a0`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
