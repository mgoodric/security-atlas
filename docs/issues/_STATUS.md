...
**Last reconciled:** 2026-05-16 (batch 38 merged · 103/106/107 on main + 108/109 spillovers ready · slice-093 UI fill-in suite + backend joins COMPLETE · 103/108 on main)
...
| 109 | sqlc toolchain pin + regen reset                                    | `ready`     | —                                                       | —      | —          | —          | spillover from 106 · infra · ~0.25d · AFK · no deps · pin sqlc version in justfile + regen reset + optional informational CI drift-check job · prevents future slices from hand-extending dbx files (slice 106 had to work around toolchain drift)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
