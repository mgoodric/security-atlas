...
**Last reconciled:** 2026-05-22 (batch 102 reconcile · 116 + 175 → merged + spillovers 203 + 204 filed)
...
| 203 | Dark-mode stylesheet wiring (theme selection actually themes the UI)                              | `ready`                       | —                                                       | —      | —                   | —          | filed 2026-05-22 via continuous-batch spillover from user feedback on v1.14.0 release (logo invisible on light bg + dark mode UI useless) · frontend · AFK · 0.5d · 8 ACs · root cause = slice 170 explicitly deferred dark-mode CSS wiring (settings/page.tsx:710-714 comment); slice 176's ThemeAwareLogo reads data-theme but nothing writes `class="dark"` so `.dark { ... }` rules never apply · fix = add early inline script in layout.tsx + extend choose() in settings to write class                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
