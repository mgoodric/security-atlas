...
**Last reconciled:** 2026-05-21 (batch 94 claim-stake · 200 SOLO → in-progress)
...
| 200 | Fix self-host bundle external-mode postgres init regression                                       | `in-progress`                 | quality/200-self-host-external-mode-fix                 | —      | —                   | —          | batch 94 · SOLO · spillover from slice 196 · Quality/Infra · JUDGMENT · 0.5d · 6 ACs · root-cause-then-fix the external-mode `test-self-host-bundle.sh` failure · hypothesis: empty `POSTGRES_HOST_AUTH_METHOD` short-circuits initdb's POSTGRES_DB step                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
