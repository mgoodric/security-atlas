...
| 101 | /policies list view (per slice 093 mockup)                          | `in-progress` | frontend/101-policies-list-view                         | —      | 2026-05-16 | —          | batch 37 · AFK · 1-2d · deps 093/005/022/023/098 all merged · consumes `GET /v1/policies` + per-row ack rate · reuses 098's shell · spillover candidate: backend `?include=ack_rate` extension (to lift per-row fan-out)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
