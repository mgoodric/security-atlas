...
**Last reconciled:** 2026-05-21 (batch 92 claim-stake · 144 + 199 → in-progress)
...
| 144 | Rename-tenant flow (per-tenant admin or super_admin)                                              | `in-review`                   | backend/144-rename-tenant                               | gh#462 | 2026-05-21          | —          | backend/frontend/multi-tenancy · AFK · 0.5d · PATCH /v1/tenants/{id} · unblocked 2026-05-21 by slice 192 spine-completion (gh#458) · batch 92 parallel-pair with 199 · 8/9 ACs (AC-8 Playwright deferred) · ~50 min engineer wall-clock · **discovered + filled the `tenants` table schema gap** that slice 192 referenced but never created (LOWER(name) UNIQUE + four-policy RLS + me_audit_log CHECK extension)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| 199 | Cross-tab BroadcastChannel sync for tenant-switcher                                               | `in-review`                   | frontend/199-tenant-broadcast-channel                   | gh#461 | 2026-05-21          | —          | filed 2026-05-21 · spillover from slice 192 · Frontend · AFK · 0.5d · enhance `<TenantSwitcher>` so switching tenants in one tab updates other tabs in real time via `BroadcastChannel` · batch 92 parallel-pair with 144                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
