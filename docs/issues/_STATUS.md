...
**Last reconciled:** 2026-05-19 (batch 75 reconcile · 138 → merged · 4-entity export cluster closes · slot collision resolved 176→177)
...
| 133 | mkdocs user docs content refresh (slice 058 follow-on)                                | `in-progress` | docs/133-mkdocs-content-refresh                       | —      | 2026-05-19 | —          | claimed 2026-05-19 · spillover from 132 · docs · AFK · 2-3d · 8 ACs · per-primitive how-to + audit-log trio guide + CI hardening reference + connector authoring guide · reuses slice-132 screenshot pipeline · dep #132 merged at `1ed75a3`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
