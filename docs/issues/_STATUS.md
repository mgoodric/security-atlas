...
**Last reconciled:** 2026-05-19 (batch 72 reconcile + slices 172/173 row flips)
...
| 172 | MCP server foundation + read-only tools                                               | `in-progress` | backend/172-mcp-server-foundation                       | gh#380 | 2026-05-19 | —          | filed 2026-05-19 via /idea-to-slice from maintainer feature ask · doc landed via PR #380 at `278ade9` · backend/infra · JUDGMENT · 3-4d · 18 ACs · 13 P0 anti-criteria · STRIDE has-mitigations · stdio transport; bearer auth via env; 6 read tools (controls/control/risks/risk/evidence/audit_periods) · cmd/atlas-mcp/ new build target · pre-boundary (no audit-binding writes) · deps merged (003 + 034 + 145) · claim-stake 2026-05-19                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 173 | MCP server write tools (create / update operations)                                   | `not-ready` | —                                                       | gh#380 | —          | —          | filed 2026-05-19 via /idea-to-slice as spillover from 172 · doc landed via PR #380 at `278ade9` · backend/infra · JUDGMENT · 3-5d · skeleton 16 ACs · preliminary STRIDE = HOLD-pending-review (re-run at pickup) · MCP write tools + HITL approval flow integration per CLAUDE.md "AI-assist boundary" · 3 viable HITL patterns documented (draft-then-confirm / shadow-table / co-sign-at-tool-time) · gate: 172 merged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
