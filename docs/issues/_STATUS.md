...
**Last reconciled:** 2026-05-22 (batch 103 claim-stake · 203 + 205 PARALLEL → in-progress)
...
| 203 | Dark-mode stylesheet wiring (theme selection actually themes the UI)                              | `in-progress`                 | frontend/203-dark-mode-stylesheet-wiring                | —      | —                   | —          | batch 103 · PARALLEL with 205 · frontend · AFK · 0.5d · 8 ACs · adds early inline script in layout.tsx + extends choose() in settings to write `class="dark"` so existing `.dark { --background: ... }` rules in globals.css apply                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 205 | Comprehensive demo seed dataset (showcase tenant + evidence across all primitives)                | `in-progress`                 | backend/205-demo-seed-dataset                           | —      | —                   | —          | batch 103 · PARALLEL with 203 · maintainer demo-site request · backend (seed/fixtures) + quality (docs) · JUDGMENT · 3d · 23 ACs · new opt-in CLI `atlas-cli demo seed --tenant-slug=<slug>` populates one polished tenant · ~50 controls / ~20 risks / ~200 evidence / 3+ frameworks · env-var-gated, never auto-runs on bootstrap · NEW migration adds `users.demo_only` flag                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
