...
| 058 | User docs scaffold + 5 core pages                      | `in-progress` | infra/058-user-docs-scaffold                            | —      | 2026-05-15 | —          | batch 27 · branch `infra/058-user-docs-scaffold` · JUDGMENT · `docs-site/**` + `justfile` spine touch + new `.github/workflows/docs-publish.yml` · no migration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
