...
**Last reconciled:** 2026-05-21 (batch 92 reconcile · 144 + 199 → merged)
...
| 196 | Bootstrap OAuth migration (atlas-cli credentials → OAuth client)                                  | `ready`                       | —                                                       | —      | —                   | —          | filed 2026-05-21 · spillover from slice 191 · Backend/CLI · AFK · 0.5-1d · migrates the `atlas-cli credentials issue` bootstrap path from credstore → OAuth client_credentials                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
