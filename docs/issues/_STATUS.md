...
**Last reconciled:** 2026-05-20 (batch 78 reconcile · 179 + 182 → merged · parallel pair)
...
| 174 | UCF anchor catalog export (all three formats)                                         | `ready`     | —                                                       | —      | —          | —          | **demand gate cleared 2026-05-20 + D1 locked 2026-05-20 by maintainer: ship all three formats** — `format=json` nested with `framework_satisfactions` array · `format=xlsx` two-sheet workbook (Anchors + Edges) · `format=csv` flat-nested fallback. Right tool per consumer (programmers → json, auditors → xlsx, CLI → csv). · filed 2026-05-19 as spillover from slice 137 D1 (rejected Option B nested + Option C two-sheet for control export; both viable here because data is public-domain anchors) · backend/frontend · AFK · 1-2d · 8 ACs · slice 135 export library does the heavy lifting                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| 181 | Open-governance pre-commitments (GOVERNANCE.md + funding signals + bus-factor plan)   | `ready`     | —                                                       | —      | —          | —          | filed 2026-05-20 as pre-commitment foundation for OQ #5 resolution (Option A pure community OSS, time-bounded) · Docs / Governance · AFK · 0.5d · 15 ACs · 9 P0 anti-criteria · threat-model verdict: CLEAN · GOVERNANCE.md at repo root + .github/FUNDING.yml + README "Project status" section + CONTRIBUTING.md cross-link + first quarterly governance-checkin baseline · re-evaluation trigger locked: 2028-05-20 OR 100 deployed self-hosts (whichever first) · no telemetry; no CLA; DCO-only                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
