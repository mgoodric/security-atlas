...
**Last reconciled:** 2026-05-22 (batch 100 claim-stake · 131 PARALLEL → in-progress)
...
| 131 | Fix slice 029 integration tests' `SET LOCAL $1` syntax error                                      | `in-progress`                 | backend/131-set-local-parameterized-fix                 | —      | —                   | —          | batch 100 · PARALLEL with 143 · backend (test infra) · AFK · 0.25d · spillover from slice 126 · pure test-harness fix: replace broken `SET LOCAL $1` parameterized call with canonical `tenancy.ApplyTenant(ctx, tx)` pattern in `TestSlice029_AppendOnlyAtDBLayer` + `TestSlice029_DeleteRejectedAtDBLayer`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
