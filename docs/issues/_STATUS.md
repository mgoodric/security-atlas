...
**Last reconciled:** 2026-05-22 (batch 104 claim-stake · 206 SOLO → in-progress + spec filed)
...
| 206 | BFF auth cookie migration from `sa_session_token` to `atlas_jwt` (slice 197 follow-on)            | `in-progress`                 | frontend/206-bff-cookie-migration                       | —      | —                   | —          | batch 104 · SOLO · DEPLOYMENT-BLOCKING bug fix · frontend/auth · AFK · 1d · 11 ACs · live-debugged 2026-05-22 against v1.14.0 deployed instance · BFF reads legacy `sa_session_token` (retired by slice 197) instead of `atlas_jwt` (set by OIDC callback post-slice-198) → infinite login loop · 30+ call sites; constant-value rename in `web/lib/auth.ts` minimizes churn · also extends proxy.ts exemptions for `/v1/*` + `/metrics` so API responses bypass HTML-307 redirect                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
