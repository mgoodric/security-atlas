...
**Last reconciled:** 2026-05-21 (slice 193 claim-stake → in-review · post-batch-88)
...
| 189 | OAuth `/oauth/authorize` + PKCE + frontend OAuth client integration                        | `in-progress` | backend/189-oauth-authorize-pkce                        | —      | 2026-05-21 | —          | filed 2026-05-21 · auth-substrate-v2 spine slot 3 · Backend/Auth + Frontend · JUDGMENT · 2-3d · 26 ACs · 10 P0 anti-criteria · ships `/oauth/authorize` + PKCE S256 (RFC 7636) + auth_code redemption on `/oauth/token` + oauth_auth_codes + oauth_client_redirect_uris + frontend oauth-client.ts + sweeper · open-redirect prevented via registered redirect URI table · PKCE-only browser flow (no implicit grant) · gate 188 merged at c0e7531 (batch 87) · batch 88 SOLO claim                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| 193 | Diagnose + fix dashboard.spec.ts AC-5 upcoming-row Playwright failure                      | `in-review`   | quality/193-dashboard-upcoming-fixture                  | gh#446 | 2026-05-21 | —          | spillover from slice 111 (filed via PR #443 / merged at `05aa114`) · Quality · JUDGMENT · 0.5d · diagnose H1 (fixture gap in dashboard.sql against /v1/upcoming) vs H2 (testid drift on upcoming-panel rendering); orchestrator-filed because slice 111 engineer skipped local test step · batch 88 parallel-pair with 189 · verdict H1 (fixture gap) · fix: status `'approved'` → `'active'` + `ON CONFLICT (id) DO UPDATE` (slice 168 precedent) + activated_by/at for SoD · local DB-contract test PASSES · spillover slice 194 filed for CI path-filter gap                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
