...
| 027 | Walkthrough recording (annotated + hash/sign)          | `in-progress` | audit/027-walkthrough-recording                      | —     | 2026-05-13 | —          | batch 19 (N=3) · AFK · migration slot \_025 · canonical sha256 hash · S3 multipart · PDF render (possible spine touch)                                                                                                                              |
