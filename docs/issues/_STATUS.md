...
**Last reconciled:** 2026-05-18 (batch 47 claim-stake · 121 → in-progress)
...
| 121 | atlas OTel SDK (traces + metrics + Go runtime telemetry)               | `in-progress` | infra/121-atlas-otel-sdk                                | —      | 2026-05-18 | —          | batch 47 claim-stake · solo-pick · infra (observability) · AFK · 2.5d · 24 ACs · OTel SDK init (TracerProvider + MeterProvider + propagators, env-var-configured, no-op when `OTEL_EXPORTER_OTLP_ENDPOINT` unset) + HTTP/DB/NATS spans + Go runtime metrics + opt-in `/metrics` fallback · companion to PR #234 (observability deploy bundle, already merged) · no technical deps                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
