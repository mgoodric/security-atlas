...
**Last reconciled:** 2026-05-14 (batch 22 merged — 016 + 020 + 041 → merged · 53/63 on main)
...
| 040 | Program dashboard view                                 | `ready`     | —                                                    | —     | —          | —          | **NEWLY UNBLOCKED** (batch 22) · deps 005/012/016/020/024 all merged                                                                                                                                                                                                                                                                                                                                                                                   |
...
| 055 | Decision Log CRUD + linkage                            | `ready`     | —                                                    | —     | —          | —          | **NEWLY UNBLOCKED** (batch 22) · deps 052/020/021 all merged                                                                                                                                                                                                                                                                                                                                                                                           |
...
| 064 | Control-detail backend read endpoints                  | `ready`     | —                                                    | —     | —          | —          | **NEW** (from slice 041 decisions log) · fills the 4 placeholders slice 041 shipped: `GET /v1/evidence?control_id=`, `GET /v1/controls/{id}/policies`, `GET /v1/controls/{id}/risks`, `GET /v1/controls/{id}/history` · deps 012/013/015/020/022 all merged · same 060→062 pattern                                                                                                                                                                     |
...
| 031 | Monthly board brief (templated)       | board    | 2-3     | **newly unblocked** · deps 012/016/020 merged                                              |
| 038 | Helm chart for K8s                    | infra    | 2       | dep 037 merged · leaf slice                                                                |
| 040 | Program dashboard view                | frontend | 2-3     | **newly unblocked** · deps 005/012/016/020/024 merged                                      |
| 055 | Decision Log CRUD + linkage           | risk     | 2       | **newly unblocked** · deps 052/020/021 merged                                              |
| 058 | User docs scaffold + 5 core pages     | docs     | 3       | deps 005 + 050 merged · JUDGMENT-type (docs authorship) · `justfile` spine touch           |
| 064 | Control-detail backend read endpoints | admin    | 1.5-2   | **new** (from slice 041 decisions log) · deps 012/013/015/020/022 merged · AFK             |

**Seven slices ready** (030, 031, 038, 040, 055, 058, 064). Spine-touch conflicts: 030 (`pyproject.toml`) and 058 (`justfile`) can't share a batch. 031/040/055/064 are all conflict-light (031 + 040 are read-model/frontend; 055 is risk-schema CRUD; 064 is backend read endpoints + `httpserver.go` mount-append). 040 depends on no unmerged slice but reads 031's board surfaces conceptually — they don't share files.

## In-flight (0 worktrees building)

Batch 22 fully merged — no worktrees building.
