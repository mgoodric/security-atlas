# 281 — Coverage lift — `internal/eval` to 70%+
...
- **P0-281-1.** Does NOT raise the `internal/eval` floor without writing
  the unit tests that hit the new bar.
- **P0-281-2.** Does NOT lower any existing floor — every change to
  `thresholds` is monotonically ↑.
- **P0-281-3.** Does NOT modify `_STATUS.md` from inside this
