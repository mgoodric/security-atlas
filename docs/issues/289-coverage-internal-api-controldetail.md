# 289 — Coverage lift — `internal/api/controldetail` to 70%+
...
- **P0-289-1.** Does NOT raise the `internal/api/controldetail` floor without writing
  the unit tests that hit the new bar.
- **P0-289-2.** Does NOT lower any existing floor — every change to
  `thresholds` is monotonically ↑.
- **P0-289-3.** Does NOT modify `_STATUS.md` from inside this
