# 296 — Coverage lift — `internal/policy/seed` to 70%+
...
- **P0-296-1.** Does NOT raise the `internal/policy/seed` floor without writing
  the unit tests that hit the new bar.
- **P0-296-2.** Does NOT lower any existing floor — every change to
  `thresholds` is monotonically ↑.
- **P0-296-3.** Does NOT modify `_STATUS.md` from inside this
