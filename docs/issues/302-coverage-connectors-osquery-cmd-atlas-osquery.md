# 302 — Coverage lift — `connectors/osquery/cmd/atlas-osquery` to 70%+
...
- **P0-302-1.** Does NOT raise the `connectors/osquery/cmd/atlas-osquery` floor without writing
  the unit tests that hit the new bar.
- **P0-302-2.** Does NOT lower any existing floor — every change to
  `thresholds` is monotonically ↑.
- **P0-302-3.** Does NOT modify `_STATUS.md` from inside this
