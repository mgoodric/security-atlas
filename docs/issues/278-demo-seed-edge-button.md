...
| **R** Repudiation            | Admin reseeds the demo tenant then denies doing so.           | Per-invocation meta-audit row captures `actor_id`, `action='demo_seed'                                                                                                                                                            | 'demo_teardown'`, `ip`, timestamp. |
