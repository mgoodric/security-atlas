...
var RouteSpecs = []RouteSpec{
	...
	{Method: "GET", Path: "/v1/evidence/receipts/{record_id}", Tag: "evidence", Tier: "bearer", Internal: false, Summary: "GET /v1/evidence/receipts/{record_id}"},
	...
	{Method: "GET", Path: "/v1/incidents", Tag: "incidents", Tier: "bearer", Internal: false, Summary: "GET /v1/incidents"},
	{Method: "GET", Path: "/v1/incidents/{id}", Tag: "incidents", Tier: "bearer", Internal: false, Summary: "GET /v1/incidents/{id}"},
	...
	{Method: "PATCH", Path: "/v1/incidents/{id}/transition", Tag: "incidents", Tier: "bearer", Internal: false, Summary: "PATCH /v1/incidents/{id}/transition"},
	...
	{Method: "POST", Path: "/v1/incidents", Tag: "incidents", Tier: "bearer", Internal: false, Summary: "POST /v1/incidents"},
	{Method: "POST", Path: "/v1/incidents/{id}/close", Tag: "incidents", Tier: "bearer", Internal: false, Summary: "POST /v1/incidents/{id}/close"},
