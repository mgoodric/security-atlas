...
var RouteSpecs = []RouteSpec{
	...
	{Method: "GET", Path: "/v1/admin/crosswalk-edges/{id}/audit", Tag: "admin-crosswalk-review", Tier: "adminBearer", Internal: false, Summary: "GET /v1/admin/crosswalk-edges/{id}/audit — one mapping's content-edit + tier-transition trails (slice 536b)"},
	{Method: "GET", Path: "/v1/admin/crosswalk-review", Tag: "admin-crosswalk-review", Tier: "adminBearer", Internal: false, Summary: "GET /v1/admin/crosswalk-review — paginated STRM mapping review queue with slice-536a conflict findings (slice 536b)"},
	...
	{Method: "PATCH", Path: "/v1/admin/crosswalk-edges/{id}", Tag: "admin-crosswalk-review", Tier: "adminBearer", Internal: false, Summary: "PATCH /v1/admin/crosswalk-edges/{id} — edit a mapping's STRM content; writes an append-only audit row (slice 536b)"},
