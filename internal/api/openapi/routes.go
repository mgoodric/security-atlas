...
var RouteSpecs = []RouteSpec{
	...
	{Method: "GET", Path: "/v1/access-reviews", Tag: "access-reviews", Tier: "bearer", Internal: false, Summary: "GET /v1/access-reviews — campaign index (?status= filter; OE-670)"},
	{Method: "GET", Path: "/v1/access-reviews/{id}", Tag: "access-reviews", Tier: "bearer", Internal: false, Summary: "GET /v1/access-reviews/{id} — one campaign + completion rollup + review items (OE-670)"},
	{Method: "GET", Path: "/v1/access-reviews/{id}/revoke-list.csv", Tag: "access-reviews", Tier: "bearer", Internal: false, Summary: "GET /v1/access-reviews/{id}/revoke-list.csv — revoke-decision CSV export; the operator enforcement handoff, no route revokes access (OE-670)"},
	...
	{Method: "GET", Path: "/v1/audit-periods/{id}/controls/{controlID}/evidence-summary", Tag: "audit-periods", Tier: "bearer", Internal: false, Summary: "GET /v1/audit-periods/{id}/controls/{controlID}/evidence-summary"},
	...
	{Method: "GET", Path: "/v1/evidence-summary/portfolio", Tag: "evidence", Tier: "bearer", Internal: false, Summary: "GET /v1/evidence-summary/portfolio"},
	...
	{Method: "GET", Path: "/v1/personnel-security/checklists", Tag: "personnel-security", Tier: "bearer", Internal: false, Summary: "GET /v1/personnel-security/checklists — onboarding/offboarding checklist index (?kind= ?status= ?overdue=true filters; OE-663)"},
	{Method: "GET", Path: "/v1/personnel-security/checklists/{id}", Tag: "personnel-security", Tier: "bearer", Internal: false, Summary: "GET /v1/personnel-security/checklists/{id} — one checklist with its items (OE-663)"},
	...
	{Method: "GET", Path: "/v1/questionnaires/{id}/answer-runs/{runId}", Tag: "questionnaires", Tier: "bearer", Internal: false, Summary: "GET /v1/questionnaires/{id}/answer-runs/{runId}"},
	...
	{Method: "POST", Path: "/v1/access-reviews", Tag: "access-reviews", Tier: "bearer", Internal: false, Summary: "POST /v1/access-reviews — create a campaign (JSON = SCIM-sourced snapshot, multipart/form-data = manual entitlement CSV; OE-670)"},
	{Method: "POST", Path: "/v1/access-reviews/{id}/complete", Tag: "access-reviews", Tier: "bearer", Internal: false, Summary: "POST /v1/access-reviews/{id}/complete — complete a campaign; emits the access_review.completion.v1 CC6.3 evidence record (OE-670)"},
	{Method: "POST", Path: "/v1/access-reviews/{id}/items/{itemID}/attest", Tag: "access-reviews", Tier: "bearer", Internal: false, Summary: "POST /v1/access-reviews/{id}/items/{itemID}/attest — keep/revoke attestation by the assigned reviewer (OE-670)"},
	...
	{Method: "POST", Path: "/v1/board/narrative/generate-all", Tag: "board", Tier: "bearer", Internal: false, Summary: "POST /v1/board/narrative/generate-all — draft the full multi-section narrative"},
	...
	{Method: "POST", Path: "/v1/personnel-security/checklist-items/{id}/complete", Tag: "personnel-security", Tier: "bearer", Internal: false, Summary: "POST /v1/personnel-security/checklist-items/{id}/complete — complete an item (completed_by, evidence_uri, notes); writes the personnel_security.workflow.v1 CC1 evidence record (OE-663)"},
	{Method: "POST", Path: "/v1/personnel-security/checklists", Tag: "personnel-security", Tier: "bearer", Internal: false, Summary: "POST /v1/personnel-security/checklists — create a manual checklist (kind, person, control_id, due_at; OE-663)"},
	...
	{Method: "POST", Path: "/v1/questionnaires/{id}/questions/{qid}/scf-mapping/ai-suggest", Tag: "questionnaires", Tier: "bearer", Internal: false, Summary: "POST /v1/questionnaires/{id}/questions/{qid}/scf-mapping/ai-suggest"},
	{Method: "POST", Path: "/v1/questionnaires/{id}/questions/{qid}/scf-mapping/{proposalID}/approve", Tag: "questionnaires", Tier: "bearer", Internal: false, Summary: "POST /v1/questionnaires/{id}/questions/{qid}/scf-mapping/{proposalID}/approve"},
	{Method: "POST", Path: "/v1/questionnaires/{id}/questions/{qid}/scf-mapping/{proposalID}/reject", Tag: "questionnaires", Tier: "bearer", Internal: false, Summary: "POST /v1/questionnaires/{id}/questions/{qid}/scf-mapping/{proposalID}/reject"},
