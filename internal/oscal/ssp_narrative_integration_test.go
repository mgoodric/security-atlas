...
func (b *captureBridge) ImportComponentDefinition(_ context.Context, _ []byte, _ string) (*oscalv1.ImportComponentDefinitionResponse, error) {
	return &oscalv1.ImportComponentDefinitionResponse{}, nil
}
